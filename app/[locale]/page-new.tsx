...
export default async function Home({
    ...
    return (
        <div className="min-h-screen bg-[#f8f6f3]">
                ...
                <nav className="max-w-[1600px] mx-auto px-[5%] py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden md:flex items-center gap-[3.5rem]">
                            <Link href="#stem-cell" className="text-[#1a1a1a] text-[0.85rem] font-normal tracking-[1px] uppercase transition-all duration-300 relative after:content-[''] after:absolute after:bottom-[-5px] after:left-0 after:w-0 after:h-[1px] after:bg-[#4a9b7f] after:transition-[width] after:duration-300 hover:after:w-full">
                                Treatments
                            </Link>
                            <Link href="#doctors" className="text-[#1a1a1a] text-[0.85rem] font-normal tracking-[1px] uppercase transition-all duration-300 relative after:content-[''] after:absolute after:bottom-[-5px] after:left-0 after:w-0 after:h-[1px] after:bg-[#4a9b7f] after:transition-[width] after:duration-300 hover:after:w-full">
                                Doctors
                            </Link>
                            <Link href="#pricing" className="text-[#1a1a1a] text-[0.85rem] font-normal tracking-[1px] uppercase transition-all duration-300 relative after:content-[''] after:absolute after:bottom-[-5px] after:left-0 after:w-0 after:h-[1px] after:bg-[#4a9b7f] after:transition-[width] after:duration-300 hover:after:w-full">
                                Pricing
                            </Link>
            ...
            {/* 9. Contact Section */}
            <section id="contact" className="px-[5%] py-[8rem] bg-[#f8f6f3]">
                <div className="max-w-[1600px] mx-auto">
                    <div className="text-center max-w-[900px] mx-auto mb-[4rem]">
                        <div className="text-[0.75rem] tracking-[3px] uppercase text-[#4a9b7f] mb-4 font-medium">
                            Get in Touch
                    ...
                    <div className="grid md:grid-cols-[1fr_1.5fr] gap-[4rem] max-w-[1200px] mx-auto">
                        ...
                        {/* Contact Form */}
                        <form className="bg-white p-10 shadow-lg">
