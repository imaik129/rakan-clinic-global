...
export default async function Home({
  ...
  return (
    <div className="min-h-screen bg-[#f8f6f3] scroll-smooth">
      ...
      <section className="px-[5%] py-[2rem] bg-[#1a1a1a] text-white">
        <div className="max-w-[1000px] mx-auto">
          <h3 className="font-['Cormorant_Garamond'] text-[1.5rem] mb-4 font-light text-center">
          ...
          <div className="grid md:grid-cols-2 gap-3 mb-4">
            {['evidence', 'certification', 'sterility', 'consent', 'followup'].map((point) => (
              <div key={point} className="flex gap-2 items-start">
                <svg className="w-4 h-4 text-[#4a9b7f] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <p className="text-[0.8rem] font-light text-white/80">
                  {t(`safetyNotice.points.${point}`)}
                </p>
              </div>
            ))}
          </div>
          <div className="text-center p-4 bg-white/5 rounded-md border border-white/10">
            <p className="text-[0.75rem] font-light italic text-white/70">
      ...
      {/* 11. Footer */}
      <footer className="bg-[#1a1a1a] text-white/60 px-[5%] py-6 border-t border-white/5">
        <div className="max-w-[1600px] mx-auto text-center">
          <div className="font-['Cormorant_Garamond'] text-[1.2rem] text-white mb-1">
            {t('footer.brand.name')}
          </div>
          ...
          <div className="flex justify-center items-center gap-3 mb-3">
            <a
              href="https://instagram.com/rakanclinicglobal"
              target="_blank"
